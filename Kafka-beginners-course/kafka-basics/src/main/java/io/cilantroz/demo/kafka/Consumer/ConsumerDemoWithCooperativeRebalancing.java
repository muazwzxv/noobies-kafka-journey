...
public class ConsumerDemoWithCooperativeRebalancing {
    ...
    public static void main(String[] args) {
        ...
        // Set rebalance strategy to CooperativeStickyAssignor
        ...
        try {
            ...
            // poll for data
            while (true) {
                // We commented the log to study how the consumer group are assigned what topics
                // log.info("Polling .......");
